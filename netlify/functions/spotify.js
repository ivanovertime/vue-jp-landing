...
const CLIENT_TOKEN = process.env.SPOTIFY_CLIENT_TOKEN

const TOKEN_ENDPOINT = 'https://accounts.spotify.com/api/token'

const ARTISTS_ENDPOINT = 'https://api.spotify.com/v1/artists/12TET0GvQuCAO3O1tfwrf4/albums'

export async function handler(event, context) {
  return getAccessToken()
    .then((result) => {
      return getTopArtists(result.body)
    })
    .then((success) => {
